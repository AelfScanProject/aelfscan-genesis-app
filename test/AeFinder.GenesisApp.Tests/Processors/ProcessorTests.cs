...
public class ProcessorTests: GenesisAppTestBase
{
    ...
    private readonly IReadOnlyRepository<AeFinder.GenesisApp.Entities.ContractInfo> _contractInfoRepository;
    ...
    public ProcessorTests()
    {
        ...
        _contractInfoRepository = GetRequiredService<IReadOnlyRepository<AeFinder.GenesisApp.Entities.ContractInfo>>();
